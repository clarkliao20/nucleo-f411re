...
/* Definitions for Servo00 */
osThreadId_t Servo00Handle;
const osThreadAttr_t Servo00_attributes = {
  .name = "Servo00",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityHigh,
};
/* Definitions for Button01 */
osEventFlagsId_t Button01Handle;
const osEventFlagsAttr_t Button01_attributes = {
  .name = "Button01"
};
/* USER CODE BEGIN PV */
void setPWM(uint16_t);
void PWMRotate(int16_t);
/* USER CODE END PV */
...
//    osThreadResume(Blink01Handle);
  }
  /* USER CODE END 5 */
}

/* USER CODE BEGIN Header_Servo00_Control */
/**
* @brief Function implementing the Servo00 thread.
* @param argument: Not used
* @retval None
*/
